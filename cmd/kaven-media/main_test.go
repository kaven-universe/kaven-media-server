...
func TestRunCheck(t *testing.T) {
	...
	if len(jsonReport.SchemaVersions) != 5 || jsonReport.SchemaVersions[0] != 1 || jsonReport.SchemaVersions[1] != 2 || jsonReport.SchemaVersions[2] != 3 || jsonReport.SchemaVersions[3] != 4 || jsonReport.SchemaVersions[4] != 5 {
	...
	if err := os.WriteFile(filepath.Join(dataDir, "upload", "orphan.jpg"), []byte("orphan"), 0o600); err != nil {
	...
	if !strings.Contains(output.String(), "orphan_file upload/orphan.jpg") {
