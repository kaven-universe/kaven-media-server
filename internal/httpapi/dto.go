...
// ErrorCode is the stable numeric result code used by upload endpoints.
type ErrorCode int
...
// ImageMetadata is returned by the image metadata and image-list endpoints.
...
// listings. Pointer fields distinguish omitted values from zero values.
...
// Timestamp uses the JavaScript Date.toISOString representation: UTC with
